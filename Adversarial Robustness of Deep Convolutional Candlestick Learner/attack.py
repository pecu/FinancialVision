...
if __name__ == '__main__':
	PARAMS = dict()
	PARAMS['data'] = './data/label8_eurusd_10bar_1500_500_val200_gaf_culr.pkl'
	PARAMS['model_name'] = './models/merged_model_0.9178.h5'  # use model trained with merged examples for instance
