...
def get_model(params):
    ...
    # Conv1
    model.add(Conv2D(16, (4, 4), input_shape=(10, 10, 4), padding='same', strides=(1,1)))
    model.add(Activation('sigmoid'))

    # Conv2
    model.add(Conv2D(16, (4, 4), padding='same', strides=(1,1)))
    model.add(Activation('sigmoid'))
...
def print_result(data, model):
    ...
    test_result_cm = confusion_matrix(test_label, test_pred, labels=[0, 1, 2, 3, 4, 5, 6, 7, 8])
